	...
	<div id="container">
		...
		<div>
			<section id="div-saldo-mes">
				<div id="div-info">
					<span class="text-align-center" id="mes">Abril 2022</span> <span
						class="text-align-center" id="text-saldo-mes">Saldo do mês</span>
				...
				<div id="div-despesas-orcamento">
					...
					<div>
						<span>Orçamento do mês</span> <span>R$ 2.350,00</span>
					</div>
				</div>
			...
			<section id="div-despesas-por-categoria">
				...
				<div>
					<div id="div-grafico">
						<img src="./recources/image/grafico.svg" alt="Gráfico" />
					</div>
			...
			<div id="div-planejamento-do-mes">
				...
				<div id="div-definir-novo-orcamento">
					<button type="button" id="btn-definir-novo-orcamento"
						class="btn btn-primary">Definir novo orçamento</button>
				</div>
			</div>
		</div>
	</div>
					...
					<div class="modal-body">
						...
						<div class="mb-3">
							<label for="descricao-receita" class="form-label">
								Descrição</label> <input type="text" name="descricao"
	...
	<div class="modal fade" id="modal-despesa" tabindex="-2" role="dialog"
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="mb-3">
						<label for="descricao-receita" class="form-label">Descrição</label>
					...
					<div class="form-check">
						<input class="form-check-input" type="checkbox" value=""
							...
							for="flexCheckChecked"> Não </label>
					</div>
